...
* Add a generator to generate the controller and views
* Figure out a way to run a rails generate email_manager:install at the start of each rspec run and delete afterwards
